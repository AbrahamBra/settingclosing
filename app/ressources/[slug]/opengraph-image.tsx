...
const titles: Record<string, { title: string; category: string }> = {
  ...
  'signal-recrutement-linkedin': { title: 'Le recrutement comme signal', category: 'Signaux' },
  'signal-changement-poste-linkedin': { title: 'Le changement de poste comme signal', category: 'Signaux' },
  'signal-levee-de-fonds-linkedin': { title: 'La levée de fonds comme signal', category: 'Signaux' },
  'parametres-linkedin': { title: 'Paramètres LinkedIn', category: 'Guide pratique' },
  'restrictions-linkedin-prospection': { title: 'Restrictions LinkedIn', category: 'Guide pratique' },

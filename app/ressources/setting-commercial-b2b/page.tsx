...
const howToSchema = {
  '@context': 'https://schema.org',
  '@type': 'HowTo',
  name: 'Comment faire du setting B2B sur LinkedIn (9 \u00e9tapes)',
  alternateName: ['Comment faire du setting', 'M\u00e9thode setting LinkedIn'],
  description: "Comment faire du setting commercial B2B en 2026 : pipeline en 9 \u00e9tapes pour g\u00e9n\u00e9rer des RDV qualifi\u00e9s via LinkedIn, organis\u00e9 en 3 phases \u2014 D\u00e9tection des signaux d'achat, Qualification des prospects, Conversion en rendez-vous.",
  totalTime: 'P90D',
  estimatedCost: { '@type': 'MonetaryAmount', currency: 'EUR', value: '790' },
  supply: [
    { '@type': 'HowToSupply', name: 'Compte LinkedIn (gratuit ou Sales Navigator)' },
    { '@type': 'HowToSupply', name: 'Outil de d\u00e9tection de signaux (Reactin, Spyer)' },
    { '@type': 'HowToSupply', name: 'IA de co-r\u00e9daction (Claude, ChatGPT)' },
  ],
  tool: [
    { '@type': 'HowToTool', name: 'LinkedIn Sales Navigator' },
    { '@type': 'HowToTool', name: 'Reactin (d\u00e9tection signaux inbound)' },
    { '@type': 'HowToTool', name: 'Spyer (signaux outbound)' },
  ],
  step: [
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "La m\u00e9thode setting B2B qui marche en 2026 combine quatre briques : (1) un ICP d\u00e9fini pr\u00e9cis\u00e9ment avec poste, secteur, taille, d\u00e9clencheur r\u00e9cent. (2) La d\u00e9tection de signaux d'achat \u2014 likes, commentaires, changements de poste, demandes de connexion \u2014 via Sales Navigator + Reactin ou Spyer. (3) La co-r\u00e9daction des messages avec une IA (Claude, ChatGPT) puis validation humaine syst\u00e9matique avant envoi. (4) Une s\u00e9quence de 1 message + 2 relances maximum espac\u00e9es de 7 jours, ferm\u00e9e proprement \u00e0 J+21. Cible chiffr\u00e9e : 50-100 messages calibr\u00e9s par semaine, 20-35 % de taux de r\u00e9ponse, 2 \u00e0 4 RDV qualifi\u00e9s par semaine en r\u00e9gime de croisi\u00e8re.",
  },
  {
        ...
        <div className="container-max max-w-3xl px-6 md:px-8">
          ...
          <section className="mt-16 pt-10 border-t border-white/[0.06]">
            ...
            <ul className="font-sans text-sm text-text-secondary leading-relaxed space-y-2 list-disc pl-5">
              <li>
                <strong className="text-text-primary">HubSpot — State of Sales Report.</strong>{' '}
                Données annuelles sur l&apos;évolution des taux de réponse, durées de cycles et stack d&apos;outils B2B.{' '}
              ...
              <li>
                <strong className="text-text-primary">LinkedIn Sales Solutions — State of Sales.</strong>{' '}
                \u00c9tude annuelle sur les pratiques de social selling et de prospection LinkedIn B2B en Europe.{' '}
              ...
              <li>
                <strong className="text-text-primary">Gartner — B2B Buying Journey Research.</strong>{' '}
                \u00c9tude sur le parcours d&apos;achat B2B et la fragmentation des décisions (groupes d&apos;achat, signaux d&apos;intention).{' '}
                <a href="https://www.gartner.com/en/sales/insights/b2b-buying-journey" target="_blank" rel="noopener noreferrer nofollow" className="text-accent hover:underline">
                  gartner.com/en/sales/insights
                </a>
              </li>
              <li>
                <strong className="text-text-primary">Données internes Setting.live.</strong>{' '}
                Statistiques agrégées sur 20+ clients en 2026 et 500+ campagnes de setting LinkedIn B2B 2024-2026.{' '}

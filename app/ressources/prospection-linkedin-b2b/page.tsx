...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'Prospection LinkedIn B2B 2026 : 20\u202f%+ de r\u00e9ponse, m\u00e9thode IA | Setting',
    description: "Signaux d'achat + IA + validation humaine. 15 exemples de messages, s\u00e9quences de relances. 2 \u00e0 4 RDV qualifi\u00e9s par semaine.",
  },
}
...
const faqItems = [
  ...
  {
    question: 'Quels r\u00e9sultats peut-on attendre de la prospection LinkedIn B2B en 2026 ?',
    answer:
      "En r\u00e9gime de croisi\u00e8re (apr\u00e8s 4 \u00e0 6 semaines de calibration) : 2 \u00e0 4 RDV qualifi\u00e9s par semaine, taux de r\u00e9ponse moyen entre 20 et 35 % sur les s\u00e9quences signal-based, et un d\u00e9lai de premier RDV inf\u00e9rieur \u00e0 7 jours. Pour rep\u00e8re : la prospection LinkedIn classique (sans signal, messages g\u00e9n\u00e9riques) tourne autour de 2 \u00e0 5 % de taux de r\u00e9ponse. Le diff\u00e9rentiel vient du ciblage par signaux d\u2019achat et de la validation humaine de chaque message avant envoi.",
  },
  {
    question: 'Quel est le ROI moyen d\u2019une campagne de prospection LinkedIn B2B ?',
    answer:
      "Sur la base de nos donn\u00e9es 2026 (20+ clients accompagn\u00e9s) : pour un ticket moyen de 5 000 \u20ac et 8 RDV qualifi\u00e9s par mois, le ROI d\u00e9passe 5\u00d7 d\u00e8s le 2e mois. Concr\u00e8tement, 790 \u20ac/mois de prospection externalis\u00e9e g\u00e9n\u00e8re entre 25 000 et 60 000 \u20ac de pipeline qualifi\u00e9 par mois, avec un taux de closing typique de 20 \u00e0 30 % apr\u00e8s discovery. Le seuil de rentabilit\u00e9 est franchi d\u00e8s qu\u2019un client est sign\u00e9.",
  },
  {
    question: 'Faut-il automatiser sa prospection LinkedIn ou rester en manuel en 2026 ?',
    answer:
      "Ni l\u2019un ni l\u2019autre seul ne fonctionne. L\u2019automatisation pure (Lemlist, Waalaxy) tourne \u00e0 2-5 % de taux de r\u00e9ponse parce que les messages sont d\u00e9tectables. Le manuel pur ne tient pas \u00e0 l\u2019\u00e9chelle au-dessus de 30 messages par semaine. La combinaison gagnante : IA pour la d\u00e9tection des signaux et la co-r\u00e9daction, humain pour la validation et l\u2019envoi. C\u2019est ce qui maintient le taux de r\u00e9ponse au-dessus de 20 %.",
  },
]
          ...
          <section className="mt-16 pt-10 border-t border-white/[0.06]">
            ...
            <ul className="font-sans text-sm text-text-secondary leading-relaxed space-y-2 list-disc pl-5">
              ...
              <li>
                ...
                Statistiques annuelles sur les taux de réponse, le temps moyen avant conversion et les outils de prospection B2B.{' '}
              ...
              <li>
                <strong className="text-text-primary">Salesloft — Benchmarks Report.</strong>{' '}
                Données comparatives sur les taux de réponse multi-canal (LinkedIn, email, téléphone) en prospection B2B.{' '}
                <a href="https://salesloft.com/resources/" target="_blank" rel="noopener noreferrer nofollow" className="text-accent hover:underline">
                  salesloft.com/resources
                </a>
              </li>
              <li>
                <strong className="text-text-primary">Données internes Setting.live.</strong>{' '}
                Statistiques agrégées sur 20+ clients accompagnés en 2026 et 500+ campagnes 2024-2026.{' '}

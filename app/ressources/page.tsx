...
export const metadata: Metadata = {
  title: 'Ressources prospection LinkedIn B2B 2026 : guides + scripts',
  description:
    "30+ guides, scripts et méthodes pour prospecter en B2B : signaux d'achat LinkedIn, messages qui décrochent des RDV, externalisation, closing et ROI chiffré.",
  openGraph: {
    title: 'Ressources prospection LinkedIn B2B 2026 — guides, scripts, méthodes | Setting',
    description:
      "30+ guides pour prospecter en B2B en 2026 : signaux d'achat LinkedIn, scripts, messages qui décrochent des RDV, externalisation et closing.",
    locale: 'fr_FR',
    type: 'website',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'Ressources prospection LinkedIn B2B 2026 — guides + scripts | Setting',
    description: "30+ guides pour prospecter en B2B en 2026 : signaux d'achat, scripts, messages qui décrochent.",
  },
}

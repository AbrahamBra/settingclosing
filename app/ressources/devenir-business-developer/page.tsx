...
export const metadata: Metadata = {
  title: 'Devenir Business Developer en 2026 | Reconversion, Alternance, Formation',
  description:
    'Tout savoir sur le métier de business developer : quotidien, salaire, compétences, et comment se former en alternance depuis Chartres avec Back School et ChallengersLab.',
  keywords: [
    'business developer',
  ...
  openGraph: {
    title: 'Business developer : le métier que vous ne connaissiez pas (et qui recrute)',
    description:
    ...
    <>
      ...
      <main className="bg-bg-primary pt-28 pb-24">
        <div className="container-max max-w-3xl px-6 md:px-8">
          ...
          <p className="font-sans text-text-muted leading-relaxed mb-14">
          ...
          <section id="commercial-2025" className="mb-14 scroll-mt-24">
            ...
            <ul className="space-y-2 mb-6">
              {[
                ...
                <li key={item} className="flex gap-3 font-sans text-text-muted text-sm leading-relaxed">
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={href}>
                    <a
                      href={href}
                      className="font-sans text-sm text-text-muted hover:text-text-primary transition-colors flex items-center gap-2"
                    >

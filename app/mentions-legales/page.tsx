          ...
          <div className="prose-legal font-sans text-text-primary leading-relaxed space-y-10">
            ...
            <section>
              ...
              <ul className="list-none space-y-1 text-text-muted">
                <li><strong>Nom commercial :</strong> Setting</li>
                <li><strong>Exploitant :</strong> Abraham Brakha</li>
                <li><strong>Forme juridique :</strong> Entrepreneur individuel</li>
                <li><strong>SIREN :</strong> 902 889 385</li>
                <li><strong>SIRET (siège) :</strong> 902 889 385 00016</li>
                <li><strong>N° TVA intracommunautaire :</strong> FR09902889385</li>
                <li><strong>Code APE :</strong> 70.22Z &mdash; Conseil pour les affaires et autres conseils de gestion</li>
                <li><strong>Inscription RNE :</strong> 06/09/2021</li>
                <li><strong>Directeur de la publication :</strong> Abraham Brakha</li>
                <li><strong>Email :</strong> <a href="mailto:a.brakha@challengerslab.com" className="text-accent hover:underline">a.brakha@challengerslab.com</a></li>
                <li><strong>Adresse :</strong> 50B rue Salomon Reinach, 69007 Lyon, France</li>
              </ul>
              <p className="text-text-muted text-sm mt-4">
                Setting est l&apos;un des noms commerciaux d&apos;Abraham Brakha (EI), au m&ecirc;me titre que ChallengersLab. Les deux marques sont op&eacute;r&eacute;es sous le m&ecirc;me num&eacute;ro SIRET.
              </p>
            </section>

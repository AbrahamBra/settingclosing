...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    {
      url: 'https://setting.live/externaliser-prospection-linkedin',
      lastModified: new Date('2026-03-19'),
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    ...
    {
      url: 'https://setting.live/glossaire',
      lastModified: new Date('2026-03-18'),
      changeFrequency: 'monthly',
      priority: 0.6,
    },
    ...
    {
      url: 'https://setting.live/mentions-legales',
      lastModified: new Date('2026-03-18'),
      changeFrequency: 'yearly',
      priority: 0.3,
    },
    {
      url: 'https://setting.live/politique-confidentialite',
      lastModified: new Date('2026-03-18'),
      changeFrequency: 'yearly',
      priority: 0.3,
    },

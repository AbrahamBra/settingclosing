...
export const metadata: Metadata = {
  title: 'Glossaire setting & closing B2B — 18 termes définis',
  description:
    "Setter, closer, signal d'achat, ICP, qualification, discovery, pipeline : 18 termes du setting et du closing B2B définis sans jargon, illustrés par des exemples LinkedIn concrets.",
  openGraph: {
    title: 'Glossaire setting & closing B2B — 18 termes définis | Setting',
    description:
      "Setter, closer, signal d'achat, ICP, pipeline : 18 termes du setting B2B définis sans jargon, avec exemples LinkedIn concrets.",
    locale: 'fr_FR',
    type: 'website',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'Glossaire setting & closing B2B — 18 termes définis | Setting',
    description: "Setter, closer, signal d'achat, ICP, pipeline : 18 termes du setting B2B définis sans jargon, exemples concrets.",

...
export const metadata: Metadata = {
  title: 'Externaliser sa prospection LinkedIn B2B : 790 € vs 50k €/an',
  description:
    "Agence, SDR interne ou setting externalisé ? Comparatif chiffré des coûts réels et des délais de mise en route. Premiers RDV qualifiés en 7 jours.",
  alternates: {
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: 'C\'est quoi un SDR externalisé ?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: "Un SDR externalisé (Sales Development Representative) est un commercial spécialisé dans la prospection sortante, mis à disposition par un prestataire externe sous forme d'abonnement mensuel. Il prospecte pour vous (LinkedIn, email, téléphone), qualifie les leads et remplit l'agenda du closer. À la différence d'un SDR interne (35 000 à 45 000 €/an salaire + 45 % de charges + 3 à 6 mois de ramp-up), le SDR externalisé est opérationnel sous 7 jours, sans engagement, à partir de 790 €/mois. Le risque opérationnel (turnover, formation, management) reste chez le prestataire.",
      },
    },
    {
      '@type': 'Question',
      name: 'SDR externalisé vs agence de prospection : quelle différence ?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: "Une agence de prospection facture entre 2 000 et 5 000 €/mois avec un engagement 3-6 mois, et travaille souvent en mode batch (envois de masse avec templates). Un SDR externalisé en mode setting (comme Setting) coûte 790 €/mois sans engagement, avec un setter dédié qui personnalise chaque message et utilise la détection de signaux d'achat. Concrètement : 3 à 5 fois moins cher, taux de réponse 4 à 10 fois supérieur, et alignement par primes au RDV qualifié.",
      },
    },
  ],
}

...
const articles = [
  ...
  { href: '/ressources/ia-methode-humain-setting-linkedin', title: 'IA, m\u00e9thode et humain\u00a0: les 3 couches du setting' },
  { href: '/ressources/script-setting-linkedin', title: 'Scripts de setting LinkedIn B2B' },
  { href: '/ressources/challenger-sale-definition', title: "Qu\u2019est-ce que le Challenger Sale\u00a0?" },
  { href: '/ressources/methodes-vente-b2b', title: 'M\u00e9thodes de vente B2B\u00a0: Challenger, SPIN, SONCAS' },
  { href: '/ressources/discovery-call-b2b', title: 'Discovery call B2B\u00a0: structure et questions' },
  { href: '/ressources/signal-achat-linkedin', title: "C\u2019est quoi un signal d\u2019achat LinkedIn\u00a0?" },
  { href: '/ressources/setter-b2b-definition', title: "C\u2019est quoi un setter en B2B\u00a0?" },
  { href: '/ressources/difference-setting-closing', title: 'Diff\u00e9rence entre setting et closing' },
  { href: '/ressources/qualification-leads-b2b', title: 'Qualifier un lead en B2B' },
  { href: '/ressources/gestion-objections-b2b', title: 'G\u00e9rer les objections en vente B2B' },
  { href: '/ressources/script-closing-b2b', title: 'Scripts et phrases de closing B2B' },
  { href: '/ressources/relance-linkedin-b2b', title: 'Relance LinkedIn B2B' },
  { href: '/ressources/closer-b2b', title: 'Closer B2B\u00a0: d\u00e9finition et comp\u00e9tences' },
  { href: '/ressources/devenir-business-developer', title: 'Devenir business developer' },
  { href: '/ressources/comment-devenir-setter-b2b', title: 'Comment devenir setter B2B' },
  { href: '/ressources/cout-setter-b2b-prix', title: "Co\u00fbt d\u2019un setter B2B" },
  { href: '/ressources/messages-linkedin-sans-reponse', title: 'Pourquoi vos messages LinkedIn restent sans r\u00e9ponse' },

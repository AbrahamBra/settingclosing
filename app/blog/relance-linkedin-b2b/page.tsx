...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://challengerslab.fr/blog/relance-linkedin-b2b',
  },
}
...
const articleSchema = {
  ...
  '@type': 'Article',
  '@id': 'https://challengerslab.fr/blog/relance-linkedin-b2b',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Blog', item: 'https://challengerslab.fr/blog' },
    {
      ...
      item: 'https://challengerslab.fr/blog/relance-linkedin-b2b',
    },
  ],
}
        ...
        <div className="container-max max-w-3xl px-6 md:px-8">
          ...
          <section id="realite" className="mb-14">
            ...
            <p className="font-sans text-text-muted leading-relaxed">
              ...
              <a href="/blog/messages-linkedin-sans-reponse" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline transition-colors">
          ...
          <section id="comment" className="mb-14">
            ...
            <div className="mb-10">
              ...
              <p className="font-sans text-text-muted text-sm leading-relaxed mb-5">
                ...
                <a href="/blog/setting-commercial-b2b" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline transition-colors">
            ...
            <div className="mb-10">
              ...
              <p className="font-sans text-text-muted text-sm leading-relaxed mb-5">
                ...
                <a href="/blog/signal-achat-linkedin" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline transition-colors">
                  signal d&apos;achat
                </a>{' '}
            ...
            <div className="mb-6">
              ...
              <p className="font-sans text-text-muted text-sm leading-relaxed mb-5">
                ...
                <a href="/blog/script-setting-linkedin" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline transition-colors">
          ...
          <div className="mt-14 pt-8 border-t border-black/8 mb-10">
            ...
            <div className="space-y-3">
              {[
                ...
                { href: '/blog/script-setting-linkedin', label: 'Scripts de setting LinkedIn B2B : exemples et cadre complet' },

...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://challengerslab.fr/blog/qualification-leads-b2b',
  },
}
...
const articleSchema = {
  ...
  '@type': 'Article',
  '@id': 'https://challengerslab.fr/blog/qualification-leads-b2b',
  ...
  inLanguage: 'fr-FR',
  url: 'https://challengerslab.fr/blog/qualification-leads-b2b',
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://challengerslab.fr/blog/qualification-leads-b2b',
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Qualification leads B2B', item: 'https://challengerslab.fr/blog/qualification-leads-b2b' },
  ],
}
          ...
          <div className="mt-14 pt-8 border-t border-black/8">
            ...
            <div className="space-y-3">
              {[
                ...
                { href: '/blog/closing-b2b', label: 'Closing B2B : définition et méthode' },
                { href: '/blog/methode-soncas', label: 'Méthode SONCAS : 6 leviers de motivation' },
                { href: '/blog/methode-spin-selling', label: 'SPIN Selling : vendre sans forcer' },

...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://challengerslab.fr/blog/difference-setting-closing',
  },
}
...
const articleSchema = {
  ...
  '@type': 'Article',
  '@id': 'https://challengerslab.fr/blog/difference-setting-closing',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Blog', item: 'https://challengerslab.fr/blog' },
    {
      ...
      item: 'https://challengerslab.fr/blog/difference-setting-closing',
    },
  ],
}

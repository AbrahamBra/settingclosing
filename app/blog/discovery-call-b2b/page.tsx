...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://challengerslab.fr/blog/discovery-call-b2b',
  },
}
...
const articleSchema = {
  ...
  '@type': 'Article',
  '@id': 'https://challengerslab.fr/blog/discovery-call-b2b',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Blog', item: 'https://challengerslab.fr/blog' },
    {
      ...
      item: 'https://challengerslab.fr/blog/discovery-call-b2b',
    },
  ],
}
          ...
          <div className="mt-14 pt-8 border-t border-black/8">
            ...
            <div className="space-y-3">
              {[
                ...
                { href: '/blog/closer-b2b', label: 'Closer B2B : définition, compétences et recrutement' },

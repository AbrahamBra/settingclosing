...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://challengerslab.fr/blog/script-setting-linkedin',
  },
}
...
const articleSchema = {
  ...
  '@type': 'Article',
  '@id': 'https://challengerslab.fr/blog/script-setting-linkedin',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Blog', item: 'https://challengerslab.fr/blog' },
    {
      ...
      item: 'https://challengerslab.fr/blog/script-setting-linkedin',
    },
  ],
}
        ...
        <div className="container-max max-w-3xl px-6 md:px-8">
          ...
          <section id="pourquoi" className="mb-14">
            ...
            <p className="font-sans text-text-muted leading-relaxed">
              Les <a href="/blog/messages-linkedin-sans-reponse" className="text-accent hover:underline transition-colors" target="_blank" rel="noopener noreferrer">messages LinkedIn sans réponse</a> ont
          ...
          <section id="scripts-inbound" className="mb-14">
            ...
            <p className="font-sans text-text-muted leading-relaxed mb-8">
              ...
              <a href="/blog/signal-achat-linkedin" className="text-accent hover:underline transition-colors" target="_blank" rel="noopener noreferrer">signaux d&apos;achat LinkedIn</a>{' '}
          ...
          <section id="scripts-outbound" className="mb-14">
            ...
            <p className="font-sans text-text-muted leading-relaxed mb-8">
              L&apos;utilisation d&apos;une{' '}
              <a href="/blog/ia-methode-humain-setting-linkedin" className="text-accent hover:underline transition-colors" target="_blank" rel="noopener noreferrer">IA comme co-rédacteur</a>{' '}

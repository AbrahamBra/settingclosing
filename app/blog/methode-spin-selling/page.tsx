...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://challengerslab.fr/blog/methode-spin-selling',
  },
}
...
const articleSchema = {
  ...
  '@type': 'Article',
  '@id': 'https://challengerslab.fr/blog/methode-spin-selling',
  ...
  inLanguage: 'fr-FR',
  url: 'https://challengerslab.fr/blog/methode-spin-selling',
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://challengerslab.fr/blog/methode-spin-selling',
  },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'SPIN Selling', item: 'https://challengerslab.fr/blog/methode-spin-selling' },
  ],
}
        ...
        <div className="container-max max-w-3xl px-6 md:px-8">
          ...
          <section id="discovery" className="mb-14 scroll-mt-24">
            ...
            <p className="font-sans text-text-muted leading-relaxed">
              ...
              <a href="/blog/discovery-call-b2b" className="text-accent hover:text-text-primary transition-colors">
          ...
          <section id="vs-challenger" className="mb-14 scroll-mt-24">
            ...
            <p className="font-sans text-text-muted leading-relaxed">
              ...
              <a href="/blog/challenger-sale-definition" className="text-accent hover:text-text-primary transition-colors">
          ...
          <div className="mt-14 pt-8 border-t border-black/8">
            ...
            <div className="space-y-3">
              {[
                { href: '/blog/closing-b2b', label: 'Closing B2B : définition, méthode et programme complet' },
                { href: '/blog/discovery-call-b2b', label: 'Discovery call B2B : structure et questions' },
                { href: '/blog/challenger-sale-definition', label: 'La méthode Challenger Sale' },
                { href: '/blog/gestion-objections-b2b', label: 'Gérer les objections en vente B2B' },
                { href: '/blog/methode-soncas', label: 'Méthode SONCAS : 6 leviers de motivation d\'achat' },
          ...
          <div className="mt-8 text-center">
            <a href="/blog" className="font-sans text-sm text-text-muted hover:text-text-primary transition-colors">← Retour au blog</a>
          </div>

...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://challengerslab.fr/blog/methodes-vente-b2b',
  },
}
...
const articleSchema = {
  ...
  '@type': 'Article',
  '@id': 'https://challengerslab.fr/blog/methodes-vente-b2b',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Blog', item: 'https://challengerslab.fr/blog' },
    {
      ...
      item: 'https://challengerslab.fr/blog/methodes-vente-b2b',
    },
  ],
}
...
const methodes = [
  {
    ...
    lien: '/blog/challenger-sale-definition',
  ...
  },
  {
    ...
    lien: '/blog/methode-spin-selling',
        ...
        <div className="container-max max-w-3xl px-6 md:px-8">
          ...
          <div className="border-l-4 border-accent bg-accent/5 rounded-r-xl px-6 py-5 mb-10">
            ...
            <p className="font-sans text-text-primary leading-relaxed">
              ...
              <a
                href="/blog/methode-spin-selling"
                className="text-accent hover:underline transition-colors"
              >
                SPIN Selling
              </a>{' '}
          ...
          <section id="combiner" className="mb-14">
            ...
            <p className="font-sans text-text-muted leading-relaxed mb-4">
              La{' '}
              <a
                href="/blog/qualification-leads-b2b"
                className="text-accent hover:underline transition-colors"
              >
          ...
          <div className="mt-14 pt-8 border-t border-black/8 mb-10">
            ...
            <div className="space-y-3">
              {[
                { href: '/blog/challenger-sale-definition', label: 'Challenger Sale : d\u00e9finition, principes et mise en pratique' },
                { href: '/blog/methode-spin-selling', label: 'SPIN Selling : la m\u00e9thode pour structurer vos discovery calls' },
                { href: '/blog/methode-soncas', label: 'M\u00e9thode SONCAS : les 6 leviers de motivation en vente' },
                { href: '/blog/discovery-call-b2b', label: 'Discovery call B2B : comment mener un appel de d\u00e9couverte' },
                { href: '/blog/gestion-objections-b2b', label: 'Gestion des objections B2B : m\u00e9thode et exemples concrets' },
                { href: '/blog/qualification-leads-b2b', label: 'Qualification de leads B2B : crit\u00e8res et processus' },
                { href: '/blog/closing-b2b', label: 'Closing B2B : guide complet pour conclure vos ventes' },
                { href: '/blog/setting-commercial-b2b', label: 'Setting commercial B2B : d\u00e9finition, m\u00e9thode et programme' },
              ].map(({ href, label }) => (
                <a
                  key={href}
                  href={href}

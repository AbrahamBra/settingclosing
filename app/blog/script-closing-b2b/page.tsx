...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://challengerslab.fr/blog/script-closing-b2b',
  },
}
...
const articleSchema = {
  ...
  '@type': 'Article',
  '@id': 'https://challengerslab.fr/blog/script-closing-b2b',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Blog', item: 'https://challengerslab.fr/blog' },
    {
      ...
      item: 'https://challengerslab.fr/blog/script-closing-b2b',
    },
  ],
}
      ...
      <main className="bg-bg-primary pt-28 pb-24">
        <div className="container-max max-w-3xl px-6 md:px-8">
          ...
          <div className="mt-14 pt-8 border-t border-black/8">
            ...
            <div className="space-y-3">
              {[
                ...
                { href: '/blog/script-setting-linkedin', label: 'Scripts de setting LinkedIn : exemples et cadre' },
              ].map(({ href, label }) => (
                <a
                  key={href}
                  href={href}
          ...
          <div className="mt-8 text-center">
            <a href="/blog" className="font-sans text-sm text-text-muted hover:text-text-primary transition-colors">
              ← Retour au blog
            </a>
          </div>

...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://challengerslab.fr/blog/methode-soncas',
  },
}
...
const articleSchema = {
  ...
  '@type': 'Article',
  '@id': 'https://challengerslab.fr/blog/methode-soncas',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Méthode SONCAS', item: 'https://challengerslab.fr/blog/methode-soncas' },
  ],
}
        ...
        <div className="container-max max-w-3xl px-6 md:px-8">
          ...
          <section id="setting-closing" className="mb-14 scroll-mt-24">
            ...
            <p className="font-sans text-text-muted leading-relaxed">
              ...
              <a href="/blog/setting-commercial-b2b" className="text-accent hover:text-text-primary transition-colors">
          ...
          <div className="mt-14 pt-8 border-t border-black/8">
            ...
            <div className="space-y-3">
              {[
                ...
                { href: '/blog/setting-commercial-b2b', label: 'Setting commercial B2B : définition et méthode' },
                { href: '/blog/challenger-sale-definition', label: 'La méthode Challenger Sale expliquée' },

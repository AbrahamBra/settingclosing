      ...
      <div className="container-max max-w-4xl">
        ...
        <ScrollReveal delay={100}>
          <p className="font-sans text-text-muted text-center text-lg leading-relaxed mb-16 max-w-2xl mx-auto">
            La prospection et le closing des solopreneurs restent artisanaux. ChallengersLab applique ce qui marche en B2B — scoring, niveaux de maturité, Challenger Sale — à ce marché.
          </p>
        </ScrollReveal>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-black/5 rounded-2xl overflow-hidden">
          <ScrollReveal delay={100}>

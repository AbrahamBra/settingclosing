  ...
  return (
    <Tag
      ...
      style={{
        ...
        boxShadow: '0 2px 16px rgba(59,130,246,0.32), 0 1px 4px rgba(59,130,246,0.18)',
      }}
      onMouseEnter={(e: any) => {
        e.currentTarget.style.transform = 'translateY(-3px)'
        e.currentTarget.style.boxShadow =
          '0 6px 24px rgba(59,130,246,0.45), 0 2px 8px rgba(59,130,246,0.25), 0 12px 32px -8px rgba(59,130,246,0.30)'
      }}
      onMouseLeave={(e: any) => {
        e.currentTarget.style.transform = 'translateY(0)'
        e.currentTarget.style.boxShadow =
          '0 2px 16px rgba(59,130,246,0.32), 0 1px 4px rgba(59,130,246,0.18)'
      }}
      {...props}
    >
      <span

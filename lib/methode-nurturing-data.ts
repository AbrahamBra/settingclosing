...
export const nurturingSteps: readonly {
  ...
  },
  {
    ...
    pedagogy: {
      ...
      arbitrage: "L\u2019optimisation hebdomadaire est non négociable. Quels emails ont performé, lesquels sont sous le benchmark\u00a0? Quels segments progressent, lesquels stagnent\u00a0? Un taux d\u2019ouverture en baisse sur le TOFU\u00a0→\u00a0on teste un nouvel angle. Un taux de routing en hausse sur le MOFU\u00a0→\u00a0le scoring fonctionne, on ne touche à rien. Les seuils bougent de 3 à 5 points par mois en moyenne jusqu\u2019à stabilisation.",
    },
  },
] as const

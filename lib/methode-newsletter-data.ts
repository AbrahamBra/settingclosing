...
export const newsletterSteps: readonly {
  ...
  },
  {
    ...
    pedagogy: {
      ...
      arbitrage: "4 contenus par cycle, chaque segment reçoit ce qui correspond à sa maturité. TOFU\u00a0: « 5 signes que votre pipeline ne fonctionne pas » — aide à identifier le problème. MOFU\u00a0: « Internaliser vs externaliser\u00a0: le comparatif chiffré » — aide à évaluer. BOFU\u00a0: « Comment nos clients ont généré 15 RDV en 60 jours » — aide à décider. Le même dirigeant, la même voix, mais quatre angles calibrés.",
    },
  },
  {
    num: '04',
